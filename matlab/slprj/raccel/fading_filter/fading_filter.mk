...
MODEL                = fading_filter
MODULES              = rt_logging.c fading_filter.c fading_filter_capi.c fading_filter_data.c fading_filter_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = fading_filter.exe
MAKEFILE             = fading_filter.mk
...
START_DIR            = C:/Users/stefa/Desktop/ego/matlab
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = fading_filter_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/fading_filter \
